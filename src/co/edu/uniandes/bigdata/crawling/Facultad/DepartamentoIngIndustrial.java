...
public class DepartamentoIngIndustrial extends DepartamentosGenerico {


	private static String dependecia="Departamento de Ingeniería Industrial";
...
//		String consulta = doc.select("iframe").attr("src");
